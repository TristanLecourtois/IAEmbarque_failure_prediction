...
#define AI_NETWORK_MODEL_SIGNATURE     "0x77d79b5d152db30d874cbecfcd6a7063"
...
#define AI_TOOLS_DATE_TIME   "2025-03-07T11:34:01+0100"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  &dense_15_dense_layer, 0xabac743d, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 76);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 76);
    dense_15_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    dense_15_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    ...
    dense_16_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    dense_16_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    dense_16_output_array.data = AI_PTR(g_network_activations_map[0] + 128);
    dense_16_output_array.data_start = AI_PTR(g_network_activations_map[0] + 128);
    ...
    dense_17_output_array.data = AI_PTR(g_network_activations_map[0] + 4);
    dense_17_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_15_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 3328);
    dense_15_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 3328);
    dense_16_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_16_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 3584);
    dense_16_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 3584);
    dense_16_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_16_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 11776);
    dense_16_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 11776);
    dense_17_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_17_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 11904);
    dense_17_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 11904);
    dense_17_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_17_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 12032);
    dense_17_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 12032);
    return true;
  }
